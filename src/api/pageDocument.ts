...
export type PageDocumentValidation = {valid:boolean; diagnostics:Array<{category:string; message:string}>; derivedText:string; linkTargets:Array<{entryId:string; title:string}>}
