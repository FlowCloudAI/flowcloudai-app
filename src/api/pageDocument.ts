...
export type PageDocumentValidation = {valid:boolean; diagnostics:Array<{category:string; message:string}>; derivedText:string; linkTargets:Array<{entryId:string|null; title:string}>}
...
export function pageDocumentValidate(html:string,css:string,projectId?:string){return invoke<PageDocumentValidation>('page_document_validate',{html,css,projectId})}
